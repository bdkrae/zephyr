...
static int teensy4_init(const struct device *dev)
{
	...
	/* LPSPI3 MISO, MOSI, SCK on Teensy-Pins 39/26/27*/
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B1_13_LPSPI3_SDI, 1);
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B1_14_LPSPI3_SDO, 1);
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_B1_15_LPSPI3_SCK, 1);
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(lpspi4), okay) && CONFIG_SPI
	/* LPSPI3 MISO, MOSI, SCK on Teensy-Pins 12/11/13*/
