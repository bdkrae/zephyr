...
| Pin | Pad ID     | Usage                               |
+=====+============+=====================================+
|  0  | AD_B0_03   | GPIO1_3 / UART6_RX                  |
+-----+------------+-------------------------------------+
|  1  | AD_B0_02   | GPIO1_2 / UART6_TX                  |
+-----+------------+-------------------------------------+
|  2  | EMC_04     | GPIO4_4                             |
+-----+------------+-------------------------------------+
|  3  | EMC_05     | GPIO4_5                             |
...
+-----+------------+-------------------------------------+
| 22  | AD_B1_08   | GPIO1_24                            |
+-----+------------+-------------------------------------+
| 23  | AD_B1_09   | GPIO1_25                            |
+-----+------------+-------------------------------------+
...
+-----+------------+-------------------------------------+
| 38  | SD_B0_05   | GPIO3_17 / UART8_RX                 |
+-----+------------+-------------------------------------+
| 39  | SD_B0_04   | GPIO3_16 / UART8_TX                 |
+-----+------------+-------------------------------------+

Only Teensy 4.1:

+-----+------------+-------------------------------------+
| 34  | B1_13      | GPIO2_29 / UART8_RX                 |
+-----+------------+-------------------------------------+
| 35  | B1_12      | GPIO2_28 / UART8_TX                 |
+-----+------------+-------------------------------------+
| 36  | B1_02      | GPIO2_18                            |
+-----+------------+-------------------------------------+
| 37  | B1_03      | GPIO2_19                            |
